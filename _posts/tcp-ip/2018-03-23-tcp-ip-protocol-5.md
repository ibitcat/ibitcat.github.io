...
- 第15、16个字节:表示窗口大小，最大是65536个字节，也就是64kb。
	...
	来**举一个例子**：有个水池，水池有进水口和出水口，通过水池现在的空闲大小，我们要动态计算进出口的水龙头开关大小。如果水池现在没水了，就要开大进水口龙头，如果水池快满了，就要关小进水口龙头。 

	那么上面的水池就是tcp缓存，水龙头就是就类似是窗口大小（水龙头可能不太准确，更准确的说，应该是一个能随意变换粗细的水管，但是现实中没有这样的的水管）。
